...
import { DECIMALS } from "./lib/aptosClient";
          ...
          <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="text-lavender-700 mb-4">
                  A decentralized marketplace powered by Aptos blockchain,
                  enabling secure and transparent peer-to-peer transactions. Buy
                  and sell products with confidence using smart contracts.
                </p>
              ...
              <div>
                <h3 className="text-sm font-semibold text-lavender-800 mb-4">
                  Quick Links
                </h3>
                <ul className="space-y-2">
                  <li>
                    <Link
                      to="/"
                      className="text-lavender-700 hover:text-lavender-900 transition-colors"
                    >
                      Browse Products
                    </Link>
                  </li>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a
                      href="#"
                      className="text-lavender-700 hover:text-lavender-900 transition-colors flex items-center"
                    >
            ...
            <div className="mt-8 pt-8 border-t border-lavender-200">
              <p className="text-center text-lavender-600 text-sm">
                © {new Date().getFullYear()} P2P Marketplace. All rights
                reserved.
              </p>
            </div>
          </div>
              ...
              {[
                ...
                >
                  ...
                  >
                    ...
                    />
                    <div>
                      <div className="text-lavender-100 font-medium">
                        {testimonial.name}
                      </div>
...
function ProductList() {
  ...
  const handlePurchase = async (product: Product) => {
    ...
    if (!account?.address && !evmAccount) {
      toast.error(
        "Please connect Petra (Aptos) or MetaMask (EVM) wallet first",
      );
      return;
    }
    ...
    try {
      ...
      if (account?.address && signAndSubmitTransaction) {
        ...
        // Use TransactionService - it will show popup when done
        const ok = await TransactionService.submitTransaction(
          signAndSubmitTransaction,
          payload,
          { maxGasAmount: "1000000", gasUnitPrice: "100" },
        );
        if (!ok) {
      ...
      if (updateError) {
        ...
        if (updateError.code === "42501") {
          console.warn("RLS policy blocked update - see console for fix");
          console.info(
            "SQL: CREATE POLICY anon_update_products ON public.products FOR UPDATE USING (true);",
          );
        }
      } else {
        fetchProducts();
        ...
        <div className="relative px-8 py-12 sm:px-12 sm:py-16">
          ...
          >
            ...
            <p className="text-xl text-lavender-800 mb-8">
              Browse through our curated collection of unique items or list your
              own products for sale. Powered by Aptos blockchain for secure and
          ...
          <div className="relative flex flex-col md:flex-row">
            ...
            <div className="md:w-1/2 p-8">
              ...
              <motion.button
                ...
                disabled={
                  (!connected && !evmAccount) || processingId === products[0].id
                }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            ...
            <motion.p
              ...
              transition={{ duration: 0.5, delay: 0.2 }}
            >
              Experience the future of e-commerce with our blockchain-powered
              marketplace
            </motion.p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              {
                ...
                description:
                  "Every transaction is secured by blockchain technology, ensuring safe and transparent payments.",
                icon: Shield,
              ...
              },
              {
                ...
                description:
                  "Lightning-fast transaction processing with minimal fees and instant confirmations.",
                icon: Zap,
              ...
              },
              {
                title: "P2P Network",
                description:
                  "Direct peer-to-peer transactions without intermediaries, reducing costs and delays.",
                icon: Network,
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            >
              <div className="text-4xl font-bold text-lavender-300 mb-2">
                10K+
              </div>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lavender-100 mb-8 max-w-2xl mx-auto">
            Join our growing community of buyers and sellers. Experience the
            future of e-commerce today.
          </p>
          <Link
            to="/sell"
